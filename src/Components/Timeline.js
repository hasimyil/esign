...
export default class Timeline extends Component{
        ...
        switch(this.props.timelineFormat){
          case 'time-show-forward':
            opStyle = {
              ...
              height: 250,// item.itemHeight ? item.itemHeight: this.props.timelineItemHeight,
        ...
        switch(this.props.timelineFormat){
          case 'time-show-forward':
            ...
            //  borderStyle: 'dashed',
              ...
              width:130,// item.itemWidth ? item.itemWidth: this.props.timelineItemWidth,
              justifyContent: 'center',
              alignItems: 'center',
            }
          break
  ...
  _renderCircle(item, index){
    ...
    var circleColor = 'lightblue'// item.circleColor?item.circleColor:this.props.circleColor;
    ...
    switch(this.props.innerCircle){
      ...
      case 'pic':
        ...
        innerCircle = (<Image source={{uri:picSource}} style={[picStyle, this.props.picStyle]} />)
      break;
    }
    return (
      <View style={[styles.circle, circleStyle, this.props.circleStyle]}>
        {
         item.signed ?
         (<Icon name={'check-circle-o'} size={circleSize-4} color={'lightbrown'} style={{backgroundColor: 'transparent'}}/>) 
         : 
         (
            <Image source={{uri:item.pic}} style={[this.props.picStyle]} />
         )
        }
      </View>
    )
  ...
  render(){
    ...
    const trueFirst = datasource.sort((a, b) => Number(b.signed) - Number(a.signed));
    return (
